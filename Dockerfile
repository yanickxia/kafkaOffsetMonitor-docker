...
ENTRYPOINT java -cp KafkaOffsetMonitor-assembly-0.2.1.jar com.quantifind.kafka.offsetapp.OffsetGetterWeb  --zk zookeeper01:2181,zookeeper02:2181,zookeeper03:2181 --port 8080  --refresh 10.seconds --retain 2.days
